...
Сейчас на экране будут показаны слова, окрашенные в различные цвета. Тебе необходимо определять ЦВЕТ, которым написано слово.
...
Сейчас на экране будут показаны слова, окрашенные в различные цвета. Но в этот раз необходимо определять написанное СЛОВО.
