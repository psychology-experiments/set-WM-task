...
какое слово было изначально. Для этого надо использовать все предложенные буквы и 
попытаться их расставить в нужном порядке. 
Искомые слова являются нарицательными существительными в единственном числе, именительном падеже. 
